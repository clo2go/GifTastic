var gif = {
        ...
        newTopicArray: [],
        //Function to populate ogArray default buttons on page load.  
        ...
        generateGifs: function(topic) {
            ...
            var queryUrl = "http://api.giphy.com/v1/gifs/search?q=funny+" + topic + "&api_key=dc6zaTOxFJmzC&limit=10";
            console.log("^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^");
